...
- [Resources](./resources.md) — CRUD on Agent, Skill, Workflow, Object, Source
...
- **Same resources everywhere.** The API surface mirrors the five concepts ([Source](../concepts/sources.md), [Object](../concepts/objects.md), [Skill](../concepts/skills.md), [Workflow](../concepts/workflows.md), [Agent](../concepts/agents.md)). If you understand the concepts, the API is already familiar.
