...
Head to `/dashboard/audit`. The workflow run is there, stamped with the active `context_sha`. Rate it 👍 or 👎 with a note. Any future prompt change is diffed against this run.
