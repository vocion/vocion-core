...
|---|---|---|
| Review queue (`/dashboard/review`, PR #337) | Detail | `ReviewFocusView` already follows the shape; adopt `DetailPage` + `useReviewDecision`, and `ReviewActionCard` drops its copy of the decide wiring |
...
| Canvases (`/dashboard/canvases`) | List | Rows with a thumbnail icon; columns: updated |
