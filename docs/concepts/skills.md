...
5. Captures rating + note (optional) at review or post-hoc — see [feedback + logs](../guides/feedback-and-logs.md).
...
- [Feedback + logs](../guides/feedback-and-logs.md) — ratings, the improvement loop
