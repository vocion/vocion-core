    ...
    <>
      <LedgerGroup label="Mon, Sep 14" count={3}>
        <LedgerEntry
          ...
          human={<a href="/dashboard/review" className="underline decoration-border underline-offset-2 hover:text-foreground">review: pending →</a>}
        />
        <LedgerEntry
          ...
          provenance={provenance}
          human={<a href="/dashboard/review" className="underline decoration-border underline-offset-2 hover:text-foreground">review: approved →</a>}
        />
        <LedgerEntry
