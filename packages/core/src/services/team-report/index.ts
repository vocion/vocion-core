...
export { type Freshness, type MeasureDimension, measureRange, type MeasureReading, type MeasureWindow, priorRange, PROVENANCE_LABEL, PROVENANCE_MEANING, type ProvenanceKind, provenanceRank, type Range, type TeamMeasure, type TeamMeasureSource, type TrendDirection, windowMs, windowPhrase } from './measures';
