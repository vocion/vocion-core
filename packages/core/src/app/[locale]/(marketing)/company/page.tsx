...
export const metadata: Metadata = {
  title: 'Company — Vocion',
  description: 'Vocion is built by MetaCTO — a product engineering studio turning AI experiments into operational systems.',
};
    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-6 py-24">
        ...
        <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
          ...
          that turns AI experiments into operational systems. We dogfood Vocion on our own sales pipeline and
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              ...
              the loop, one review queue. Vocion is that substrate, open-sourced, so the work is portable and the
