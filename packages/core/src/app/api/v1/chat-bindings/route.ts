...
/**
 * POST /api/v1/chat-bindings  { surface, channelId, agentSlug, teamId? }
...
export async function POST(req: Request) {
  ...
  try {
    const binding = await createBinding({ orgId: caller.orgId, surface, teamId, channelId, agentSlug, createdBy: caller.actorId });
