 ...
 *
 * One short greeting line and a couple of tappable prompt chips.
 * No glyphs, no product copy, no instructional labels — the composer
 * below is the whole invitation. Chips fire `onPick(prompt)` which the
 * parent shell auto-sends.
 */
...
export function EmptyState({ agentName = 'your team', suggestions = [], onPick }: EmptyStateProps) {
  return (
