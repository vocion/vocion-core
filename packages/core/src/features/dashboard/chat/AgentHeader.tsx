 ...
 *
 * Top of the chat surface: agent display name + eyebrow + amber
 * accent underline. Rev-ai sidebar pairs this with per-agent accent
 * colors; here we use the brand-amber default.
 */
...
export function AgentHeader({ name, eyebrow, description }: AgentHeaderProps) {
  return (
