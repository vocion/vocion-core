...
describe('plugin pages', () => {
  ...
  it('a Work row is about five things, and says why in words', () => {
    ...
    expect(keys).toEqual(['title', 'visual', 'status', 'blocked', 'gap', 'unmet', 'contract', 'flags', 'detail', 'why', 'cost', 'product', 'rank']);
    ...
    expect(work?.primary).toEqual({ field: 'title', thumb: 'visual', subtitle: ['status', 'blocked', 'gap', 'unmet', 'contract', 'flags', 'rank', 'detail', 'why', 'cost', 'product'] });
